...
type CodecademyGitConcept = "add" | "commit" | "branch" | "clone" | "commit" | "diff" | "log" | "merge" | "init" | "tag" | "pull";

const getCodecademyGitConcept = function (concept: CodecademyGitConcept) {
  const filepath = path.join("resources", "codecademy", "git", "concepts", concept, concept + ".md");
...
export default async function Home() {
  ...
  const source = getCodecademyGitConcept("add");
