...
Note: This status code is similar to 302 Found, except that it does not allow changing the request method from POST to GET. This specification defines no equivalent counterpart for [301 Moved Permanently](https://httpstatuses.com/301) ([RFC7238](https://tools.ietf.org/html/rfc7238), however, proposes defining the status code [308 Permanent Redirect](https://httpstatuses.com/308) for this purpose).

* * *

*   Source: [RFC7231 Section 6.4.7](https://tools.ietf.org/html/rfc7231#section-6.4.7)
