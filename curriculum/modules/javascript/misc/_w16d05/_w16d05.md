...
### Study Plan
  ...
  You can find the lecture code [here for part 1](https://github.com/in-tech-gration/WDX-180/tree/main/curriculum/week16/assets/code/day05){:target="_blank"} and [here for part 2](){:target="_blank"}

  **Suggested material for study and practice:**

  - **Practice on the Object Creator function and its Toolset**  
  - **Solve the Murdle Board challenge**
