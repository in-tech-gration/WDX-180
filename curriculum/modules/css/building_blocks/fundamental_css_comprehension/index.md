...
URL: https://github.com/in-tech-gration/content/tree/main/files/en-us/learn/css/building_blocks/fundamental_css_comprehension
---
...
- Go and grab the [HTML file for the exercise](https://github.com/in-tech-gration/WDX-180/blob/main/curriculum/modules/css/building_blocks/fundamental_css_comprehension/assets/index.html){:target="_blank"}, and the [associated image file](https://github.com/in-tech-gration/WDX-180/blob/main/curriculum/modules/css/building_blocks/fundamental_css_comprehension/assets/chris.jpg){:target="_blank"}, and save them in a new directory on your local computer. If you want to use your own image file and fill your own name in, you are welcome to — just make sure the image is square.
- Grab the [CSS resources text file](https://github.com/in-tech-gration/WDX-180/blob/main/curriculum/modules/css/building_blocks/fundamental_css_comprehension/assets/style-resources.txt){:target="_blank"} — this contains a set of raw selectors and rulesets that you'll need to study and combine to answer part of this assessment.

<!-- You could paste the HTML and fill in the CSS into one of these online editors, and use [this URL](https://mdn.github.io/learning-area/css/introduction-to-css/fundamental-css-comprehension/chris.jpg) to point the `<img>` element to the image file. If the online editor you are using doesn't have a separate CSS panel, feel free to put it in a `<style>` element in the head of the document. -->
...
![A view of the finished business card, show a reader header and footer, and a darker center panel containing the main details and image.](assets/business-card.png)
