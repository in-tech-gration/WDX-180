...
You've nearly finished this module — we only have one more thing to do. In the [Styling a biography page assessment](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/Styling_a_biography_page) you'll use your new knowledge to restyle an example, testing out some CSS in the process.
...
- **MDN**
  - [How css works](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/How_CSS_works) [(Permalink)](https://github.com/mdn/content/blob/4785cd825d3e74ffdd11740d19473cb3ae63832c/files/en-us/learn/css/first_steps/how_css_works/index.md)