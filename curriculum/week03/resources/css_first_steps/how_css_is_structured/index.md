...
- To learn CSS's fundamental syntax structures in detail.
...
![A declaration highlighted in the CSS](assets/declaration.png)
...
![A highlighted declaration block](assets/declaration-block.png)
...
![The rule for h1 highlighted](assets/rules.png)
...
At this point, you should have a better idea about how CSS is structured. It's also useful to understand how the browser uses HTML and CSS to display a webpage.
