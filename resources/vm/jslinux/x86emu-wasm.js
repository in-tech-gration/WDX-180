...
STATICTOP = STATIC_BASE + 16810192;
__ATINIT__.push({
  func: function () {
    ___emscripten_environ_constructor();
  },
});
var STATIC_BUMP = 16810192;
...
function _emscripten_async_wget3_data(
  url,
  request,
  user,
  password,
  ...
  if (user) _user = Pointer_stringify(user);
  else _user = null;
  if (password) _password = Pointer_stringify(password);
  else _password = null;
  ...
  http.onprogress = function http_onprogress(e) {
    if (onprogress)
      Runtime.dynCall("viiii", onprogress, [
        handle,
        arg,
        e.loaded,
...
Module["wasmTableSize"] = 244;
Module["wasmMaxTableSize"] = 244;
Module.asmGlobalArg = {};
